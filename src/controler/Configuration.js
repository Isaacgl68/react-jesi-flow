...
export function initTypeConfigMap(){
    return new Map([
        ...
        [FlowNodeTypes.IF_ELSE_CHILD,{type:FlowNodeTypes.IF_ELSE_CHILD, dataClass: BaseContainerDataType, icon:Icons['elseChild'],label: 'Else', editor:null, component:SimpleFlowContainer }],
